...
# ESTA É A NOVA FUNÇÃO AUXILIAR. ELA DEVE ESTAR AQUI.
...
# ESTA É A FUNÇÃO coletar_smartcitizen CORRIGIDA. ELA DEVE SUBSTITUIR A VERSÃO ANTIGA.
def coletar_smartcitizen(kit_id=18774):
    url = f"https://api.smartcitizen.me/v0/devices/{kit_id}"
    r = requests.get(url)
    data = r.json()

    # Verifica se 'data' e 'sensors' existem antes de tentar acessá-los
...
# Mantenha esta função coletar_clima como está.
...
# Mantenha este bloco principal como está.
